...
class Arte
{
  ...
  /* INCREMENTAR VISUALIZAÇAO */
  public static function addview($idArte)
  {
    $sql = "update artes set visualizacoes=visualizacoes+1 WHERE id=?";
    $params = [$idArte];
    DB::update($sql, $params);
  }
  /* INCREMENTAR GOSTEI */
  public static function addlike($idArte)
  {
    $sql = "update artes set gostei=gostei+1 WHERE id=?";
    $params = [$idArte];
    DB::update($sql, $params);
  }
}
